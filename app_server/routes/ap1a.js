...
var x = 'world';
var arr2 = [
    5, 52, 2, 60, 4, 24, 6, 1, 20, 16, 3, 99, 9, 7, 55, 44, 30, 100, 71, 11
];
...
console.log('\n\n\n\n\n jul get paid ' + employees.emp2.hourlywage)

var b = 'point';

getAverageTestScore(scores);
...
var b = 'break';
//-------- OUTPUT --------\\
var aooSorted = jInsertionSort(arr2);
console.log("jInsertionSort = [" + aooSorted + "]");

console.log("hi " + x);

// InsertionSort - 1st solution.
